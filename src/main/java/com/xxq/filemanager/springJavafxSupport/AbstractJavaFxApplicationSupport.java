package com.xxq.filemanager.springJavafxSupport;
...
public abstract class AbstractJavaFxApplicationSupport extends Application {
    ...
    public static void showView(Class<? extends AbstractFxmlView> window, Modality mode) {
        final AbstractFxmlView view = (AbstractFxmlView)applicationContext.getBean(window);
        Stage newStage = null;
    ...
    public Collection<Image> loadDefaultIcons() {
        return Arrays.asList(
                new Image(getClass().getResource("/photos/splashScreen.jpg").toExternalForm()));
